...
angular.module('studymonitorApp')
    .controller('ExpensesController', function (expensesService, $cookies, $http, $timeout, toastr, APP_MESSAGES, generateexcelFactory, $scope, School) {
        ...
        ExpensesCtrl.uploadFile = function (x) {
            ...
            var uploadUrl = "http://localhost:3000/api/ImageContainers/Expenses/upload";
            ...
            $http.post(uploadUrl, fd, {
                ...
                .then(function (response) {
                    if (response) {
                        ExpensesCtrl.file = 'http://localhost:3000/api/ImageContainers/Expenses/download/' + response.data.result[0].filename;
                    }
                }, function (error) {
        ...
        ExpensesCtrl.printExpense = function (index) {
            ...
            ExpensesCtrl.formFields.index = index;
            ExpensesCtrl.formFields.expenseType = ExpensesCtrl.expensesList[index].expenseType;
            ExpensesCtrl.formFields.claimedBy = ExpensesCtrl.expensesList[index].claimedBy;
            ExpensesCtrl.formFields.description = ExpensesCtrl.expensesList[index].description;
