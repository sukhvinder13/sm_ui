...
angular.module('studymonitorApp')
    .controller('LessonplannerControllerCtrl', function (lessonPlannerService, $sce, $scope, $cookies, $timeout, $http, APP_MESSAGES, toastr, generateexcelFactory, $window) {
            ...
            $http.post(uploadUrl, fd, {
                ...
                .then(function (response) {
                    if (response) {
                        ...
                        // topicPdfUrl.file = 'http://localhost:3000/api/ImageContainers/topicPDF/download/' + response.data.result[0].filename;
                        topicPdfUrl.file = 'http://localhost:3000/api/ImageContainers/topicPDF/download/' + response.data.result[0].filename;
