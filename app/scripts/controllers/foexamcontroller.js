...
angular.module('studymonitorApp')
  .controller('Foexamcontroller', function (FoexamService, Class, $cookies, FOexam, toastr, APP_MESSAGES, $timeout, generateexcelFactory, ExamType, Student, $window, $http) {
    ...
    FoexamsCtrl.uploadTempImage = function (index) {
      ...
      var uploadUrl = "http://localhost:3000/api/ImageContainers/ExamTemplates/upload";
      $http.post(uploadUrl, fd, {
        ...
        .then(function (response) {
          if (response) {
            ...
            FoexamsCtrl.file = 'http://localhost:3000/api/ImageContainers/ExamTemplates/download/' + response.data.result[0].filename;
          }
        }, function (error) { });
    };
