...
angular.module('studymonitorApp')
    .controller('MarksController', function (marksService, FoMarksService, $cookies, Exam, Student, Class, $timeout, School, toastr, $rootScope, Marks, $window, APP_MESSAGES, $scope, $filter, $http, FOexam, Grade) {
        ...
        MarksCtrl.buildMkShettyFormativeDataDhatrak = function () {
            ...
            for (var i = 0; i < MarksCtrl.studentMarksData.subjects.length; i++) {
                ...
                MarksCtrl.avgOfTotalGPA = gradeTotals / MarksCtrl.studentMarksData.subjects.length;
            }
            MarksCtrl.studentMarksData['totalOfAllSubjects'] = totalOfAllSubjects;
            if (MarksCtrl.formFields.formateType === 'lower') {
