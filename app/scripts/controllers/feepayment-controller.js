...
angular.module('studymonitorApp')
  ...
  FeesPaymentController.getRegNo = function(student){
    Student.findOne({ filter: { where: { id: student.studentId } } }, function (res) { console.log(res);
      student.registrationNo = res.registrationNo});
  }
});
