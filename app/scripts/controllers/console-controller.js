...
angular.module('studymonitorApp')
    .controller('ConsoleController', function (schooltimetableService, workingdaysService, gradeService, $rootScope, consoleService, ExamTypeService, Timetable, $cookies, generateexcelFactory, $filter, $timeout, $state, $scope, $sce, $http, APP_MESSAGES, toastr, Enquiry, AcademicBatch, feesService, Leave, School, WorkingDay) {
        ...
        function Init() {
            ...
            ConsoleCtrl.uploadSchoolTc = function (x) {
                ...
                $http.post(uploadUrl, fd, {
                    ...
                    .then(function (response) {
                        if (response) {
                            ConsoleCtrl.file = 'http://localhost:3000/api/ImageContainers/Schoollogo/download/' + response.data.result[0].filename;
            ...
            this.getSchoolDetails = function () {
                School.find({ filter: { where: { id: ConsoleCtrl.schoolId } } }, function (response) {
                    ...
                    ConsoleCtrl.softwareStartDate = (new Date(response[0].softwareStartDate));
                    ConsoleCtrl.DateOfEstablishment = (new Date(response[0].DateOfEstablishment));
            ...
            // this.getFinanceDetails = function () {
            //     console.log("finance");
            //     var financeID = ConsoleCtrl.schoolId;
            //     console.log(financeID);
            //     console.log("http://localhost:3000/api/FeePayments/getDueData?schoolId=" + financeID);
            //     $http({

            //         method: 'GET',

            //         url: "http://localhost:3000/api/FeePayments/getDueData?schoolId=" + financeID,
