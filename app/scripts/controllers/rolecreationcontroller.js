...
angular.module('studymonitorApp')
  .controller('RolecreationcontrollerCtrl', function (Parent, roleCreationService, $timeout, toastr, APP_MESSAGES, $state, $cookies, $http, $window, ManageRole, $rootScope) {
    this.awesomeThings = [
      'HTML5 Boilerplate',
      'AngularJS',
      'Karma'
    ...
    function Init() {
      ...
      this.getRolecreationDetailsAdmin = function () {
        $http({
          "url": 'http://localhost:3000/api/ManageRoles?filter={"where":{"schoolId":"' + RolecreationCtrl.schoolId + '"}}',
          "method": "GET",
        ...
        $http({
          "url": 'http://localhost:3000/api/ManageRoles?{"schoolId":"' + RolecreationCtrl.schoolId + '"}',
          "method": "PUT",
          "headers": { "Content-Type": "application/json" }
        })
          .then(function (response) {
        ...
        // roleCreationService.getRolecreationDetailsBySchoolIdAdmin(RolecreationCtrl.schoolId).then(function (response) {
        //   // alert("ssskskskskskss");
        //   if (response) {
        //     RolecreationCtrl.RoleCreationlistAdmin = response;
        //   }
        // }, function (error) {
    ...
    // (new Init()).getRolecreationDetailsAccountant();
    // (new Init()).getRolecreationDetailsStaff();
    // (new Init()).getRolecreationDetailsParent();
    // (new Init()).getRolecreationDetailsStudent();
    ...
    RolecreationCtrl.checkViewAdmin = function (recordID, data, index) {
      // for(var q=0;q<RolecreationCtrl.RoleCreationlistAdmin.RolesData.length;q++){

      //   var data1 = RolecreationCtrl.RoleCreationlistAdmin.RolesData[q].name;
      //   if(data1 === data.w.name){
      //     var index = q;
      //   }
      // }
      // return;
      ...
      $http({
        "url": 'http://localhost:3000/api/ManageRoles',
        "method": "PUT",
        "data": {
      ...
      // ManageRole.prototype$patchAttributes({ id: schoolId, RolesData: RolecreationCtrl.RoleCreationlistAdmin.RolesData })
    };
    RolecreationCtrl.checkEditAdmin = function (recordID, data, index) {
      ...
      // ManageRole.prototype$patchAttributes({ id: recordID, RolesData: RolecreationCtrl.RoleCreationlistAdmin.RolesData }, function (response) {
      //   if (response) {
      //     (new Init()).getRolecreationDetailsAdmin();
      //   }
      // // })
    ...
    RolecreationCtrl.checkViewStudent = function (recordID, data, index) {
      ...
      // ManageRole.prototype$patchAttributes({ id: recordID, RolesData: RolecreationCtrl.RoleCreationlistStudent.RolesData })
      $http({
        "url": 'http://localhost:3000/api/ManageRoles',
        "method": "PUT",
        "data": {
    ...
    RolecreationCtrl.checkEditStudent = function (recordID, data, index) {
      ...
      // ManageRole.prototype$patchAttributes({ id: recordID, RolesData: RolecreationCtrl.RoleCreationlistStudent.RolesData }, function (response) {
      //   if (response) {
      //     (new Init()).getRolecreationDetailsStudent();
      //   }
      // })
    ...
    RolecreationCtrl.checkViewStaff = function (recordID, data, index) {
      ...
      // ManageRole.prototype$patchAttributes({ id: recordID, RolesData: RolecreationCtrl.RoleCreationlistStaff.RolesData })
      $http({
        "url": 'http://localhost:3000/api/ManageRoles',
        "method": "PUT",
        "data": {
    ...
    RolecreationCtrl.checkEditStaff = function (recordID, data, index) {
      ...
      // ManageRole.prototype$patchAttributes({ id: recordID, RolesData: RolecreationCtrl.RoleCreationlistStaff.RolesData }, function (response) {
      //   if (response) {
      //     (new Init()).getRolecreationDetailsStaff();
      //   }
      // })
    ...
    RolecreationCtrl.checkViewAccountant = function (recordID, data, index) {
      ...
      // ManageRole.prototype$patchAttributes({ id: recordID, RolesData: RolecreationCtrl.RoleCreationlistAccountant.RolesData })
    };
    RolecreationCtrl.checkEditAccountant = function (recordID, data, index) {
      ...
      // ManageRole.prototype$patchAttributes({ id: recordID, RolesData: RolecreationCtrl.RoleCreationlistAccountant.RolesData }, function (response) {
      //   if (response) {
      //     (new Init()).getRolecreationDetailsAccountant();
      //   }
      // })
    ...
    RolecreationCtrl.checkViewParent = function (recordID, data, index) {
      ...
      // ManageRole.prototype$patchAttributes({ id: recordID, RolesData: RolecreationCtrl.RoleCreationlistParent.RolesData })
    };
    RolecreationCtrl.checkEditParent = function (recordID, data, index) {
      ...
      // ManageRole.prototype$patchAttributes({ id: recordID, RolesData: RolecreationCtrl.RoleCreationlistParent.RolesData }, function (response) {
      //   if (response) {
      //     (new Init()).getRolecreationDetailsParent();
      //   }
      // })
