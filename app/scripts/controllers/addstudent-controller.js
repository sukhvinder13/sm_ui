...
angular.module('studymonitorApp')
  .controller('AddstudentController', function (addStudentService, AcademicBatch, ManageRole, School, $filter, $cookies, toastr, APP_MESSAGES, $timeout, $stateParams, $http, $state, Student) {
    ...
    $http({
      "url": 'http://localhost:3000/api/ManageRoles?filter={"where":{"schoolId":"' + AddStudentCtrl.schoolId + '","type":"Student"}}',
      "method": "GET",
    ...
    AddStudentCtrl.getSchoolName = function () {
      $http.get(urlBase + '/Schools/' + $cookies.getObject('uds').schoolId)
        .then(function (response) {
    ...
    AddStudentCtrl.uploadStudentImage = function (x) {
      ...
      var uploadUrl = "http://localhost:3000/api/ImageContainers/Students/upload";
      $http.post(uploadUrl, fd, {
        ...
        .then(function (response) {
          if (response) {
            AddStudentCtrl.file = 'http://localhost:3000/api/ImageContainers/Students/download/' + response.data.result[0].filename;
          }
        }, function (error) {
    ...
    AddStudentCtrl.uploadSchoolTc = function (x) {
      ...
      var uploadUrl = "http://localhost:3000/api/ImageContainers/StudentTC/upload";
      $http.post(uploadUrl, fd, {
        transformRequest: angular.identity,
        headers: {
          'Content-Type': undefined
        ...
        .then(function (response) {
          if (response) {
            AddStudentCtrl.tcFile = 'http://localhost:3000/api/ImageContainers/StudentTC/download/' + response.data.result[0].filename;
          }
        }, function (error) {
          console.log('Error while fetching the assignment records. Error stack : ' + error);
        });
    ...
    AddStudentCtrl.adhaar = function (x) {
      ...
      var uploadUrl = "http://localhost:3000/api/ImageContainers/StudentAdhaar/upload";
      $http.post(uploadUrl, fd, {
        transformRequest: angular.identity,
        headers: {
          'Content-Type': undefined
        ...
        .then(function (response) {
          if (response) {
            AddStudentCtrl.adhaarFile = 'http://localhost:3000/api/ImageContainers/StudentAdhaar/download/' + response.data.result[0].filename;
          }
        }, function (error) {
          console.log('Error while fetching the assignment records. Error stack : ' + error);
        });
    ...
    AddStudentCtrl.uploadCasteCerti = function (x) {
      ...
      var uploadUrl = "http://localhost:3000/api/ImageContainers/StudentCasteCerti/upload";
      $http.post(uploadUrl, fd, {
        transformRequest: angular.identity,
        headers: {
          'Content-Type': undefined
        ...
        .then(function (response) {
          if (response) {
            AddStudentCtrl.castecertiFile = 'http://localhost:3000/api/ImageContainers/StudentCasteCerti/download/' + response.data.result[0].filename;
          }
        }, function (error) {
          console.log('Error while fetching the assignment records. Error stack : ' + error);
        });
    ...
    AddStudentCtrl.uploadDOBCerti = function (x) {
      ...
      var uploadUrl = "http://localhost:3000/api/ImageContainers/StudentDOBCerti/upload";
      $http.post(uploadUrl, fd, {
        transformRequest: angular.identity,
        headers: {
          'Content-Type': undefined
        ...
        .then(function (response) {
          if (response) {
            AddStudentCtrl.dobFile = 'http://localhost:3000/api/ImageContainers/StudentDOBCerti/download/' + response.data.result[0].filename;
          }
        }, function (error) {
          console.log('Error while fetching the assignment records. Error stack : ' + error);
        });
