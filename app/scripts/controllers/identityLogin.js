...
angular.module('studymonitorApp')
    .controller('identityLoginController', function (LoopBackAuth, identityService, $http, $timeout, $cookies, APP_MESSAGES, $state, Parent, StudentParent, Student, Accountant, toastr) {
                                ...
                                if (data.length == 1 && data[0].profiles.length == 1) {
                                    ...
                                    identityService.authenticateProfile(data).then(function (response) {
                                        if (response != null && response.data) {
                                            ...
                                            $http({
                                                "url": 'http://localhost:3000/api/ManageRoles?filter={"where":{"id":"' + identityLoginCtrl.ManagerId + '"}}',
                                                "method": "GET",
