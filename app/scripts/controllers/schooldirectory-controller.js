...
angular.module('studymonitorApp')
  .controller('SchooldirectoryController', function ($cookies, $http, schooldirectoryService, $scope, $stateParams, $location, FOsubject, $timeout, APP_MESSAGES, generateexcelFactory, toastr, $state, $compile, Mail, Parent, StudentParent, Student) {
    ...
    function Init() {
      ...
      this.getstudentdetails = function () {
        ...
        $http({
          method: "GET",
          url: "http://localhost:3000/api/Students/findrecords?schoolId=" + SchooldirectoryCtrl.schoolId + "&numb=" + 10 + "&access_token=" + ss.accessToken,
    ...
    var deleteRecord = function (data) {
      if (data.type) {
        switch (data.type) {
          ...
          // case 'Parents':
          //     SchooldirectoryCtrl.directorList = SchooldirectoryCtrl.parentList;
          //     if (SchooldirectoryCtrl.parentList) {
          //         Parent.deleteById({
          //             id: data.id
          //         }, function () {
