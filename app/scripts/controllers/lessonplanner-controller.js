...
angular.module('studymonitorApp')
    .controller('LessonplannerControllerCtrl', function (lessonPlannerService, $sce, $rootScope, $scope, $cookies, $timeout, $http, APP_MESSAGES, toastr, FOsubject, Student,Subject, generateexcelFactory, $window, LessonPlanner, $state, $stateParams) {
        ...
        lessonPlnrCtrl.uploadPPTorPDF = function (x) {
            ...
            var uploadUrl = "http://localhost:3000/api/ImageContainers/topicPDF/upload";
            $http.post(uploadUrl, fd, {
                ...
                .then(function (response) {
                    if (response) {
                        lessonPlnrCtrl.pdfFile = 'http://localhost:3000/api/ImageContainers/topicPDF/download/' + response.data.result[0].filename;
