                ...
                faN1data.map(function (item1) {
                  faN2data.map(function (item2) {
                    if (push.subjectName == item1.subjectName && push.subjectName == item2.subjectName) {
                      ...
                      var data = []
                      data.push({ submarks: (item1.fa1 / 10) * 100 });
                      data.push({ submarks: (item2.fa2 / 10) * 100 });
                      data.push({ submarks: (push.sa1Ext / 80) * 100 });
                      MarksCtrl.viewMarksData.push({ subjectName: push.subjectName, assigments: data, tempAssigment: data, total: total, flag: true })
                    }
                  })
                })
              })
