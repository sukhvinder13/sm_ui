...
angular.module('studymonitorApp')
  .controller('AddstaffController', function (addStaffService, School, $cookies, $filter, ManageRole, toastr, APP_MESSAGES, Staff, $timeout, $stateParams, $http, $state) {
    ...
    AddStaffCtrl.uploadImage = function (x) {
      ...
      var uploadUrl = "http://localhost:3000/api/ImageContainers/Staffs/upload";
      $http.post(uploadUrl, fd, {
        ...
        .then(function (response) {
          if (response) {
            AddStaffCtrl.file = 'http://localhost:3000/api/ImageContainers/Staffs/download/' + response.data.result[0].filename;
          }
        }, function (error) {
    ...
    $http({
      "url": 'http://localhost:3000/api/ManageRoles?filter={"where":{"schoolId":"' + AddStaffCtrl.schoolId + '","type":"Staff"}}',
      "method": "GET",
    ...
    AddStaffCtrl.uploadExpCerti = function (x) {
      ...
      var uploadUrl = "http://localhost:3000/api/ImageContainers/StaffExpCerti/upload";
      $http.post(uploadUrl, fd, {
        transformRequest: angular.identity,
        headers: {
          'Content-Type': undefined
        ...
        .then(function (response) {
          if (response) {
            AddStaffCtrl.ExpcertiFile = 'http://localhost:3000/api/ImageContainers/StaffExpCerti/download/' + response.data.result[0].filename;
          }
        }, function (error) {
          //   console.log('Error while fetching the assignment records. Error stack : ' + error);
        });
    ...
    AddStaffCtrl.uploadAdhaar = function (x) {
      ...
      var uploadUrl = "http://localhost:3000/api/ImageContainers/Staffadhaar/upload";
      $http.post(uploadUrl, fd, {
        transformRequest: angular.identity,
        headers: {
          'Content-Type': undefined
        ...
        .then(function (response) {
          if (response) {
            AddStaffCtrl.adhaarFile = 'http://localhost:3000/api/ImageContainers/Staffadhaar/download/' + response.data.result[0].filename;
          }
        }, function (error) {
          // console.log('Error while fetching the assignment records. Error stack : ' + error);
        });
    ...
    AddStaffCtrl.uploadPancard = function (x) {
      ...
      var uploadUrl = "http://localhost:3000/api/ImageContainers/Staffpancard/upload";
      $http.post(uploadUrl, fd, {
        transformRequest: angular.identity,
        headers: {
          'Content-Type': undefined
        ...
        .then(function (response) {
          if (response) {
            AddStaffCtrl.pancardFile = 'http://localhost:3000/api/ImageContainers/Staffpancard/download/' + response.data.result[0].filename;
          }
        }, function (error) {
          // console.log('Error while fetching the assignment records. Error stack : ' + error);
        });
