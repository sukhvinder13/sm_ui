...
angular.module('studymonitorApp')
  .controller('AddtopicController', function (addtopicService, $stateParams, $http, $cookies, $timeout, $rootScope, LessonPlanner, $filter, toastr, APP_MESSAGES, $window) {
    ...
    AddtopicCtrl.uploadPPTorPDF = function (x) {
      ...
      $http.post(uploadUrl, fd, {
        ...
        .then(function (response) {
          if (response) {
            AddtopicCtrl.pdfFile = 'http://localhost:3000/api/ImageContainers/topicPDF/download/' + response.data.result[0].filename;
