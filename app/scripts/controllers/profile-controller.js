...
angular.module('studymonitorApp')
  .controller('ProfileController', function (profileService, $cookies, $timeout, toastr, APP_MESSAGES, $state, $http) {
    ...
    ProfileCtrl.uploadProfileImage = function (index) {
      ...
      var uploadUrl = "http://localhost:3000/api/ImageContainers/ProfilePics/upload";
      $http.post(uploadUrl, fd, {
        ...
        .then(function (response) {
          if (response) {
            ...
            ProfileCtrl.file = 'http://localhost:3000/api/ImageContainers/ProfilePics/download/' + response.data.result[0].filename;
