...
angular.module('studymonitorApp')
    .service('marksService', function ($q, Marks, Class, Subject, Exam, MaxMark, Student, School, $http) {
        ...
        this.UpdateMarks = function (updatemarks) {
            ...
            var _activepromise = $q.defer();
            $http.put(urlBase + '/Marks/' + updatemarks.id, updatemarks)
        ...
        this.addMarks = function (updatemarks) {
            ...
            var _activepromise = $q.defer();
            $http.post(urlBase + '/Marks', updatemarks)
                .then(function (response) {
                    if (response) {
                        _activepromise.resolve(response);
                    }
