...
angular.module('studymonitorApp')
  .service('FoMarksService', function ($q, FOmarks, Class, FOsubject, FOexam, MaxMark, Student, School, $http, Subject) {
    ...
    this.UpdateMarks = function (updatemarks) {
      // alert("update");
      var _activepromise = $q.defer();
      $http.put(urlBase + '/FOmarks/' + updatemarks.id, updatemarks)
    ...
    this.addMarks = function (updatemarks) {
      ...
      var _activepromise = $q.defer();
      $http.post(urlBase + '/FOmarks', updatemarks)
        .then(function (response) {
          if (response) {
            _activepromise.resolve(response);
          }
